...
The system SHALL allow administrators to create, update, archive, and list projects with unique project code, name, project type, optional client name, optional description, and optional revenue or budget amount.

#### Scenario: Administrator creates project
- **WHEN** an administrator creates a project with a unique project code, name, project type, optional client name, optional description, and optional revenue or budget amount
...
#### Scenario: Internal project has no revenue requirement
- **WHEN** an administrator creates an internal project such as internal work, recruiting, or administration
- **THEN** the system allows the project to have no revenue or budget amount while still accepting plans and allocations
...
### Requirement: Project financial visibility
The system SHALL restrict project revenue and budget amounts to administrators.

#### Scenario: Administrator views project financial fields
- **WHEN** an administrator opens project management
- **THEN** the system displays and allows editing of project revenue or budget amount

#### Scenario: Member cannot view project financial fields
- **WHEN** a non-administrator views an assigned project or enters effort
- **THEN** the system does not display project revenue, budget, cost, or profit values
...
- **THEN** the system does not allow the member to change project name, code, type, client, revenue, budget, or financial fields
